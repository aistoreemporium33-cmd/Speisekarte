    ...
    <div className={`relative flex items-center justify-center ${className}`}>
        <style>
          {`
            ...
            .bubble {
              animation: bubble-up 2.5s infinite ease-out;
            }
          `}
        </style>
        <svg viewBox="0 0 240 240" xmlns="http://www.w3.org/2000/svg" className="w-full h-full overflow-visible">
            <defs>
                ...
                <linearGradient id="needleGrad" x1="0%" y1="0%" x2="0%" y2="100%">
                    <stop offset="0%" style={{ stopColor: primaryColor, stopOpacity: 1 }} />
                    <stop offset="50%" style={{ stopColor: primaryColor, stopOpacity: 1 }} />
            ...
            <g className="rh-monogram">
                {/* Champagne Bubbles in NY Mode */}
                {newYearMode && [0,1,2,3,4,5,6,7].map(i => (
                  <circle 
                    key={i}
                ...
                {/* --- KOMPASS ELEMENTE --- */}
                {/* Kompass Rose / Windrose */}
                <g transform="translate(120, 125)" opacity="0.4">
                    {/* Background Circle for Compass */}
                ...
                <g fontFamily="Cinzel, serif" fontSize="18" fontWeight="700" fill={primaryColor}>
                    <text x="120" y="32" textAnchor="middle" className="drop-shadow-sm">N</text>
                    <text x="120" y="235" textAnchor="middle" className="drop-shadow-sm">S</text>
                    <text x="225" y="132" textAnchor="middle" className="drop-shadow-sm">O</text>
                    <text x="15" y="132" textAnchor="middle" className="drop-shadow-sm">W</text>
                </g>
                ...
                <g transform="translate(120, 125)">
                    ...
                    <circle cx="0" cy="0" r="14" fill={primaryColor} stroke={secondaryColor} strokeWidth="2" />
                </g>

                {/* Rotating Compass Needle (Die Kompassnadel) */}
                <g className="compass-needle">
                    <path d="M120 70 L126 125 L114 125 Z" fill={newYearMode ? "#ffffff" : "#ffffff"} opacity="0.9" />
